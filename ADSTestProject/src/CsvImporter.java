...
public class CsvImporter {
	...
	private static void algoritmoSextaSabado(Aula aulasDesseDia, Sala sala, int slotInicial, int slotFinal) {
		...
		if (sala.getCaracteristicas().contains(aulasDesseDia.getCaracteristicaPedida()) && aulasDesseDia.getNumeroInscritos() < (sala.getCapacidadeNormal() + alunosExtra)) {
			aulasDesseDia.setSalaAtribuida(sala.getNome());
			aulasDesseDia.setLotacao(sala.getCapacidadeNormal());
			aulasDesseDia.setCaracteristicasReaisDaSala(sala.getCaracteristicasInString());
